...
function Working() {
  return (
    <>
      <div className="container-2 mt-63" id="process">
        <div className="d-flex align-items-center flex-column">
          <Comnheading text="WORKING PROCESS" />
          <h2 className=" ff-urbanist fw-bold text-40 lh-43 mb-0 mt-3">
            How does we works
          </h2>
        </div>

        <div className="d-flex mt-47 justify-content-around justify-content-lg-between flex-wrap">
          <div className="max-w-203">
            ...
            <p className=" ff-urbanist fw-bold text-24 lh-264 mb-0 mt-34">
              Idea
            </p>
            <p className=" ff-urbanist fw-normal text-16 lh-23 mb-0 mt-2">
          ...
          <div className="max-w-203 mt-sm-5 mt-4 mt-lg-0">
            <div className="outer-circle d-flex justify-content-center align-items-center">
              <div className="inner-circle d-flex justify-content-center align-items-center">
